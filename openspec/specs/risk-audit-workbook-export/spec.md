# risk-audit-workbook-export

将风控任务 canonical result 确定性导出为业务要求的单 sheet“业务总览”Excel 审计底稿。

## Purpose

让有权用户获得与 Web 工作台一致、可追溯且不携带隐藏业务数据的业务总览审计底稿，并为后续 LangGraph/ERP 演进保持稳定导出边界。
